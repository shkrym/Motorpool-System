<template>
  <div class="flex h-screen bg-gradient-to-br from-green-50 to-green-100 font-inter">
    ...
    <main class="main-content flex flex-1 flex-col transition-all duration-300 ease-in-out min-w-0" :class="{ '!ml-0': sidebarCollapsed || !sidebarOpen }">
      ...
      <!-- Header with Actions -->
      <header class="bg-gradient-to-br from-green-800 to-green-600 text-white shadow-lg backdrop-blur-xl py-5 px-8 border-b border-white/20 flex flex-col sm:flex-row justify-between items-start sm:items-center sticky top-0 z-10 gap-4 sm:gap-0">
        <div class="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div>
            <h1 class="m-0 text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight" 
                style="color: white;">Fuel Management</h1>
            <p class="text-sm text-white mt-1">Track and manage vehicle fuel consumption</p>
          </div>
        </div>
      </header>
        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex flex-col lg:flex-row gap-4">
              ...
              <div class="flex items-center gap-2 flex-wrap">
                ...
                <button 
                  @click="openAddModal"
                  class="sm:flex-none bg-gradient-to-br from-green-800 to-green-700 text-white py-3 px-2 rounded-lg flex items-center justify-center gap-2 hover:from-green-700 hover:to-green-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 whitespace-nowrap"
                >
            ...
            <div v-if="showFilters" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-200">
              <select v-model="vehicleFilter" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A400C]">
              ...
              <select v-model="driverFilter" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A400C]">
              ...
              <select v-model="dateRangeFilter" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A400C]">
          ...
          <!-- Advanced Statistics Cards -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div class="bg-white/90 backdrop-blur-xl p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group"
                ...
                <div class="text-2xl font-bold mb-0.5" style="color: #0A400C;">{{ fuelStats.totalLogs }}</div>
                <div class="text-xs text-slate-600 font-medium">Total Fuel Logs</div>
              </div>
              ...
              <div class="bg-white/90 backdrop-blur-xl p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group"
                ...
                <div class="text-2xl font-bold mb-0.5 text-blue-600">{{ fuelStats.totalLiters }}L</div>
                <div class="text-xs text-slate-600 font-medium">Total Fuel Volume</div>
              </div>
              ...
              <div class="bg-white/90 backdrop-blur-xl p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group"
                ...
                <div class="flex items-center justify-between mb-2">
                  <div class="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <i class="fas fa-peso-sign text-green-600 text-lg"></i>
                  </div>
                  <i class="fas fa-chart-line text-green-600 text-xs"></i>
                </div>
                <div class="text-2xl font-bold mb-0.5 text-green-600">₱{{ fuelStats.totalCost }}</div>
                <div class="text-xs text-slate-600 font-medium">Total Expenditure</div>
              </div>
              ...
              <div class="bg-white/90 backdrop-blur-xl p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group"
                ...
                <div class="text-2xl font-bold mb-0.5 text-orange-600">₱{{ fuelStats.avgCostPerLiter }}</div>
                <div class="text-xs text-slate-600 font-medium">Cost per Liter</div>
              </div>
            </div>
      ...
      <div class="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div class="relative py-6 px-8 bg-gradient-to-br from-green-800 to-green-600 text-white">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-2xl font-bold">{{ editingLog ? 'Edit Fuel Log' : 'Add New Fuel Log' }}</h3>
              <p class="text-green-100 text-sm mt-1">{{ editingLog ? 'Update fuel log information' : 'Record a new fuel entry' }}</p>
            </div>
            <button 
              @click="closeModal" 
